...
var _default = {
  ...
  createGestureHandler(handlerName, handlerTag, config) {
    if ((0, _EnableExperimentalWebImplementation.isExperimentalWebImplementationEnabled)()) {
      ...
      interactionManager.configureInteractions(_NodeManager.default.getHandler(handlerTag), config);
    } else {
  ...
  updateGestureHandler(handlerTag, newConfig) {
    if ((0, _EnableExperimentalWebImplementation.isExperimentalWebImplementationEnabled)()) {
      ...
      interactionManager.configureInteractions(_NodeManager.default.getHandler(handlerTag), newConfig);
    } else {
